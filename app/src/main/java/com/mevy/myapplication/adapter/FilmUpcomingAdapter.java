...
public class FilmUpcomingAdapter extends RecyclerView.Adapter<FilmUpcomingAdapter.ViewHolder>{
    private List<FilmData.Film> dataList;
    private FilmUpcomingAdapter.OnItemClickListener listener;

    public FilmUpcomingAdapter(List<FilmData.Film> dataList, FilmUpcomingAdapter.OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public FilmUpcomingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.grid_film, parent, false);
        return new FilmUpcomingAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FilmUpcomingAdapter.ViewHolder holder, int position) {
...
//        holder.textViewName.setText(data); // Atur data ke dalam TextView atau elemen lainnya
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public void bind(final FilmData.Film data, final FilmUpcomingAdapter.OnItemClickListener listener) {
